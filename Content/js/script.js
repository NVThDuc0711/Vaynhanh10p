$(document).ready(function () {
    ...
    $('.slide-Trang Chủ.owl-carousel').owlCarousel({
        animateOut: 'fadeOut',
        mouseDrag: true,
        items: 1,
        loop: true,
    ...
    $('#Trang Chủ-intro .owl-carousel, #Trang Chủ-center .owl-carousel').owlCarousel({
        items: 3,
        mouseDrag: true,
        loop: true,
        nav: true,
    ...
    $('#Trang Chủ-intro .owl-stage, #Trang Chủ-center .owl-stage').lightƯU ĐÃI({
        selector: '.item'
    });
    ...
    $('#section-stories .owl-stage').lightƯU ĐÃI({
        selector: '.item'
    });

    $('#Trang Chủ-customer .owl-carousel').owlCarousel({
        mouseDrag: true,
        items: 1,
        loop: true,
        nav: true,
